    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.Use(async (context, next) =>
            {
                ...
                //}
                if (context.Request.Path.ToString() == "/auth/login" || context.Request.Path.ToString() == "/auth/register" || context.Request.Path.ToString() == "/" ||
                //context.Request.Path == "/auth" || context.Request.Path == "/auth/email" || 
                context.Request.Path.ToString() == "/auth/logout" || /*context.Request.Path == "/auth/details" ||*/ context.Request.Path.ToString() == "/home")
                {
